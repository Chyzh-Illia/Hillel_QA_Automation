...
search_criteria = (2017, 1.6, 36000) # нижче розпаковка тапла
year, engine, max_price = search_criteria
filtered_cars = [item for item in car_data.items() if item[1][1] >= year and item[1][2] >= engine and item[1][4] <= max_price]
